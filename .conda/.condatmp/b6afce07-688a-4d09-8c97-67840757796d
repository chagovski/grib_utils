...
# installed.
TCL_PREFIX='c:/pasik/MSF/grib_utils/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/pasik/MSF/grib_utils/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='c:/pasik/MSF/grib_utils/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ic:/pasik/MSF/grib_utils/.conda\Library\include'
...
TCL_PACKAGE_PATH='c:/pasik/MSF/grib_utils/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/pasik/MSF/grib_utils/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='c:/pasik/MSF/grib_utils/.conda\Library\lib\tclstub86.lib'
